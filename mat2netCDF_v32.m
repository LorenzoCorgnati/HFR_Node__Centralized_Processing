...
function [R2C_err,networkData,stationData,ncFileNoPath,ncFilesize,station_tbUpdateFlag] = mat2netCDF_v32(HFRP_RUV,networkData,networkFields,stationData,stationFields,timestamp)

disp(['[' datestr(now) '] - - ' 'mat2netCDF_v32.m started.']);
...
if(R2C_err==0)
    disp(['[' datestr(now) '] - - ' 'mat2netCDF_v32.m successfully executed.']);
end
