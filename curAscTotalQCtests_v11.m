...
function [overall, varThr, tempDer, GDOPThr, dataDens, velThr] = curAscTotalQCtests_v11(mat_tot, Total_QC_params)
...
try
    ...
    tempDer = netcdf.getConstant('NC_FILL_BYTE').*int8(ones(size(mat_tot.U_grid)));
