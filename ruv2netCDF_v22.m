...
function [R2C_err,networkData,stationData,ncFileNoPath,ncFilesize,station_tbUpdateFlag] = ruv2netCDF_v22(HFRP_RUV,networkData,networkFields,stationData,stationFields,timestamp)

disp(['[' datestr(now) '] - - ' 'ruv2netCDF_v22.m started.']);
...
try
    ...
    netcdf.putAtt(ncid, varid_t, 'valid_min',double(-90000));
    netcdf.putAtt(ncid, varid_t, 'valid_max',double(90000));
    netcdf.putAtt(ncid, varid_t, 'uncertainty',char(''));
    ...
    netcdf.putAtt(ncid, varid_bearing, 'valid_min',single(0));
    netcdf.putAtt(ncid, varid_bearing, 'valid_max',single(360));
    netcdf.putAtt(ncid, varid_bearing, 'uncertainty',char(''));
    netcdf.putAtt(ncid, varid_bearing, 'long_name', 'Bearing away from instrument');
    netcdf.putAtt(ncid, varid_bearing, 'standard_name', '');
    ...
    netcdf.putAtt(ncid, varid_range, 'valid_min',single(0));
    netcdf.putAtt(ncid, varid_range, 'valid_max',single(90000));
    netcdf.putAtt(ncid, varid_range, 'uncertainty',char(''));
    netcdf.putAtt(ncid, varid_range, 'long_name', 'Range away from instrument');
    netcdf.putAtt(ncid, varid_range, 'standard_name', '');
    ...
    netcdf.putAtt(ncid, varid_depth, 'valid_min',single(-12000));
    netcdf.putAtt(ncid, varid_depth, 'valid_max',single(12000));
    netcdf.putAtt(ncid, varid_depth, 'uncertainty',char(''));
    netcdf.putAtt(ncid, varid_depth, '_FillValue', netcdf.getConstant('NC_FILL_FLOAT'));
    ...
    netcdf.putAtt(ncid, varid_depth, 'data_mode', 'R');    
...
%     netcdf.putAtt(ncid, varid_lat, 'valid_range', single( [-90 90]));
    ...
    netcdf.putAtt(ncid, varid_lat, 'uncertainty',char(''));
...
%     netcdf.putAtt(ncid, varid_lon, 'valid_range', single( [-180 180]));
    ...
    netcdf.putAtt(ncid, varid_lon, 'uncertainty',char(''));
...
%     netcdf.putAtt(ncid, varid_espc, 'valid_range', int16( [(-32-addOffset)./scaleFactor (32-addOffset)./scaleFactor] ));
    ...
    netcdf.putAtt(ncid, varid_espc, 'data_mode', 'R');
...
%     netcdf.putAtt(ncid, varid_etmp, 'valid_range', int16( [(-32-addOffset)./scaleFactor (32-addOffset)./scaleFactor] ));
    ...
    netcdf.putAtt(ncid, varid_etmp, 'data_mode', 'R');
    ...
    netcdf.putAtt(ncid, varid_maxv, 'standard_name', '');
%     netcdf.putAtt(ncid, varid_maxv, 'valid_range', int16( [(-10-addOffset)./scaleFactor (10-addOffset)./scaleFactor] ));
    ...
    netcdf.putAtt(ncid, varid_minv, 'standard_name', '');
%     netcdf.putAtt(ncid, varid_minv, 'valid_range', int16( [(-10-addOffset)./scaleFactor (10-addOffset)./scaleFactor] ));
    ...
    netcdf.putAtt(ncid, varid_ersc, 'standard_name', '');
%     netcdf.putAtt(ncid, varid_ersc, 'valid_range', int16( [0 127] ));
    ...
    netcdf.putAtt(ncid, varid_ertc, 'standard_name', '');
%     netcdf.putAtt(ncid, varid_ertc, 'valid_range', int16( [0 127] ));
    ...
    netcdf.putAtt(ncid, varid_xdst, 'standard_name', '');
%     netcdf.putAtt(ncid, varid_xdst, 'valid_range', int32( [0 (1e3-addOffset)./scaleFactor] ));
    ...
    netcdf.putAtt(ncid, varid_ydst, 'standard_name', '');
%     netcdf.putAtt(ncid, varid_ydst, 'valid_range', int32( [0 (1e3-addOffset)./scaleFactor] ));
    ...
    netcdf.putAtt(ncid, varid_sprc, 'standard_name', '');
...
%     netcdf.putAtt(ncid, varid_narx, 'valid_range', int8([0 maxsite] ));
    ...
    netcdf.putAtt(ncid, varid_narx, 'data_mode', 'R');
...
%     netcdf.putAtt(ncid, varid_natx, 'valid_range', int8([0 maxsite] ));
    ...
    netcdf.putAtt(ncid, varid_natx, 'data_mode', 'R');
...
%     netcdf.putAtt(ncid, varid_sltr, 'valid_range', int32( [(-90-addOffset)./scaleFactor (90-addOffset)./scaleFactor] ));
    ...
    netcdf.putAtt(ncid, varid_sltr, 'data_mode', 'R');
...
%     netcdf.putAtt(ncid, varid_slnr, 'valid_range', int32( [(-180-addOffset)./scaleFactor (180-addOffset)./scaleFactor] ));
    ...
    netcdf.putAtt(ncid, varid_slnr, 'data_mode', 'R');
...
%     netcdf.putAtt(ncid, varid_sltt, 'valid_range', int32( [(-90-addOffset)./scaleFactor (90-addOffset)./scaleFactor] ));
    ...
    netcdf.putAtt(ncid, varid_sltt, 'data_mode', 'R');
...
%     netcdf.putAtt(ncid, varid_slnt, 'valid_range', int32( [(-180-addOffset)./scaleFactor (180-addOffset)./scaleFactor] ));
    ...
    netcdf.putAtt(ncid, varid_slnt, 'data_mode', 'R');
    ...
    netcdf.putAtt(ncid, varid_scdr, 'standard_name', '');
    ...
    netcdf.putAtt(ncid, varid_scdr, 'data_mode', 'R');
    ...
    netcdf.putAtt(ncid, varid_scdt, 'standard_name', '');
    ...
    netcdf.putAtt(ncid, varid_scdt, 'data_mode', 'R');
...
%     netcdf.putAtt(ncid, varid_tqc, 'valid_range', int8( [0 9]));
    ...
    netcdf.putAtt(ncid, varid_posqc, 'long_name', 'Position quality flag');
...
%     netcdf.putAtt(ncid, varid_dqc, 'valid_range', int8( [0 9]));
    ...
    netcdf.putAtt(ncid, varid_ovqc, 'long_name', 'Overall quality flag');
...
%     netcdf.putAtt(ncid, varid_ovqc, 'valid_range', int8( [0 9]));
    ...
    netcdf.putAtt(ncid, varid_owtr, 'long_name', 'Over-water quality flag');
...
%     netcdf.putAtt(ncid, varid_owtr, 'valid_range', int8( [0 9]));
    ...
    netcdf.putAtt(ncid, varid_mdfl, 'long_name', 'Median filter quality flag');
...
%     netcdf.putAtt(ncid, varid_mdfl, 'valid_range', int8( [0 9]));
    ...
    netcdf.putAtt(ncid, varid_vart, 'long_name', 'Variance threshold quality flag');
...
%     netcdf.putAtt(ncid, varid_vart, 'valid_range', int8( [0 9]));
    ...
    netcdf.putAtt(ncid, varid_cspd, 'long_name', 'Velocity threshold quality flag');
...
%     netcdf.putAtt(ncid, varid_rdct, 'valid_range', int8( [0 9]));
    ...
    netcdf.putAtt(ncid, varid_global, 'platform_name', platform_code);
    netcdf.putAtt(ncid, varid_global, 'wmo_platform_code', '');
    netcdf.putAtt(ncid, varid_global, 'ices_platform_code', '');    
    ...
    netcdf.putAtt(ncid, varid_global, 'CF-1.6 Copernicus-InSituTAC-FormatManual-1.4 Copernicus-InSituTAC-SRD-1.41 Copernicus-InSituTAC-ParametersList-3.2.0');
    ...
    netcdf.putAtt(ncid, varid_global, 'contact', 'euhfrnode@azti.es cmems-service@ifremer.fr');
...
%     netcdf.putAtt(ncid, varid_global, 'netcdf_format', 'netcdf4_classic');
    netcdf.putAtt(ncid, varid_global, 'netcdf_version', 'netCDF-4 classic model');
    netcdf.putAtt(ncid, varid_global, 'netcdf_format', [netcdf.inqLibVers ' netcdf4_classic']);
    ...
    netcdf.putAtt(ncid, varid_global, 'institution_references', institution_websiteStr);
    netcdf.putAtt(ncid, varid_global, 'references', 'http://marine.copernicus.eu http://www.marineinsitu.eu http://www.marineinsitu.eu/wp-content/uploads/2018/02/HFR_Data_Model_Reference_Card_v1.pdf');
    netcdf.putAtt(ncid, varid_global, 'software_name', 'HFR_Node__Centralized_Processing');
    netcdf.putAtt(ncid, varid_global, 'software_version', 'v2.2');
...
if(R2C_err==0)
    disp(['[' datestr(now) '] - - ' 'ruv2netCDF_v22.m successfully executed.']);
end
