...
function [cA2C_err,networkData,ncFileNoPath,ncFilesize] = MATROOS2netCDF_v33(nc,tBC_idx,networkData,networkFields,stationData,stationFields)

disp(['[' datestr(now) '] - - ' 'MATROOS2netCDF_v33.m started.']);
...
if(cA2C_err==0)
    disp(['[' datestr(now) '] - - ' 'MATROOS2netCDF_v33.m successfully executed.']);
end
