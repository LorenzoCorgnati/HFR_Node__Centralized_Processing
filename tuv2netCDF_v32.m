...
function [T2C_err,networkData,ncFileNoPath,ncFilesize] = tuv2netCDF_v32(totFilename,timestamp,networkData,networkFields,stationData,stationFields)

disp(['[' datestr(now) '] - - ' 'tuv2netCDF_v32.m started.']);
...
if(T2C_err==0)
    disp(['[' datestr(now) '] - - ' 'tuv2netCDF_v32.m successfully executed.']);
end
